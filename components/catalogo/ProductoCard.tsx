...
export function ProductoCard({ producto, vendedorSlug }: ProductoCardProps) {
  ...
  return (
    <motion.article
      // La aparición se dispara al cargar, NO al hacer scroll. Así una tarjeta
      // nunca se queda invisible si el navegador no alcanza a detectar el scroll
      // (celular lento, "reducir movimiento" activado). Un producto escondido
